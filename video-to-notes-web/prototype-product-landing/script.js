...
const proofData = {
  parser: {
    src: "../prototype-phase1-video-parser/screenshots/final-e2e/a-02-parser-result.png",
    alt: "视频解析完成结果页面",
    shift: "-34%",
  ...
  recommend: {
    src: "../prototype-phase1-video-parser/screenshots/final-e2e/a-04-linked-recommendations.png",
  ...
  reading: {
    src: "../prototype-phase1-video-parser/screenshots/final-e2e/a-06-reading.png",
    alt: "结构化笔记成品阅读页面",
    shift: "-10%",
