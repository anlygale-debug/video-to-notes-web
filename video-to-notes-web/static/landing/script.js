...
const proofData = {
  parser: {
    ...
    title: "先把内容拿出来。",
    copy: "先解析视频信息并按需下载媒体；需要文字时，再选择免费或高速高质量转录。",
  },
  methods: {
    src: "/static/landing/assets/note-methods.png",
    alt: "逐字稿就绪后的三种笔记生成方式页面",
    shift: "-16%",
    kicker: "STEP 02 / CHOOSE A METHOD",
    title: "选择适合自己的笔记方式。",
    copy: "你可以留在本站生成，也可以使用通用提示词或 To Notes Skill，把逐字稿带进自己的 AI 工作流。",
  },
  recommend: {
    src: "/static/landing/assets/note-recommendations.png",
    alt: "系统预读逐字稿后的笔记方案推荐页面",
    shift: "-25%",
    kicker: "STEP 03 / PRE-READ",
    title: "先理解，再决定笔记结构。",
