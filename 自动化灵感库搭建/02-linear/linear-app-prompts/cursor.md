...
```ts
export const tokens = {
  colors: ['#f7f8f8', '#62666d', '#d0d6e0', '#e2e4e7', '#8a8f98', '#f79ce0', '#08090a', '#f7bf8b', '#8fa6ff', '#ffdf9f', '#83dcdc', '#00ff05', '#f34e52', '#23252a'],
  fonts: ['[object Object]', '[object Object]'],
  radii: ['1', '4', '7', '12', '16', '20'],
  shadows: ['rgba(0, 0, 0, 0.1) 0px 0px 0px 2px', 'rgba(0, 0, 0, 0.2) 0px 0px 0px 1px', 'rgb(35, 37, 42) 0px 0px 0px 1px inset'],
};
```
## Sections
- logo-wall
