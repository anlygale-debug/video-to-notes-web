...
> Extracted from `https://tailwindcss.com` on July 2, 2026
> 2571 elements analyzed
...
| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#000000` | hsl(0, 0%, 0%) | 853 |
| `#ffffff` | hsl(0, 0%, 100%) | 183 |
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#000000` | text, border, background | 853 |
| `#ffffff` | background, text, border | 183 |
| `#0080ff` | background | 1 |
| `#2ca8ff` | border | 1 |
| `#ec0853` | background | 1 |
...
- **inter** — used for all (1950 elements)
- **plexMono** — used for body (621 elements)
...
`400` (2432x), `500` (99x), `600` (37x), `700` (3x)
...
**sm** — blur: 0px
```css
box-shadow: rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, oklab(0.129999 -0.00404751 -0.027702 / 0.05) 0px 0px 0px 1px, rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.1) 0px 1px 2px -1px;
```
...
.dropdown {
  ...
  border-radius: 12px;
  box-shadow: rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, oklab(0.129999 -0.00404751 -0.027702 / 0.05) 0px 0px 0px 1px, rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.1) 0px 1px 2px -1px;
  border-color: lab(1.90334 0.278696 -5.48866);
  padding-top: 4px;
}
```
...
```css
  background: oklab(0.129999 -0.00404751 -0.027702 / 0.075);
  color: lab(1.90334 0.278696 -5.48866);
...
**75 grid containers** and **162 flex containers** detected.
...
|----------|-----------|-------------|-------------|-----------|-------------|
| mobile (375px) | 16px | No | 30 | No | 17231px |
| tablet (768px) | 16px | No | 30 | No | 14771px |
| desktop (1280px) | 16px | No | 30 | No | 11576px |
| wide (1920px) | 16px | No | 30 | No | 11605px |

### Breakpoint Changes

**375px → 768px** (mobile → tablet):
- H1 size: `36px` → `48px`
- Page height: `17231px` → `14771px`

**768px → 1280px** (tablet → desktop):
- H1 size: `48px` → `96px`
- Page height: `14771px` → `11576px`
...
```css
/* Hover */
background-color: oklab(0.129999 -0.00404751 -0.027702 / 0.05) → oklab(0.129999 -0.00404751 -0.027702 / 0.075);
```
```css
/* Focus */
background-color: oklab(0.129999 -0.00404751 -0.027702 / 0.05) → oklab(0.129999 -0.00404751 -0.027702 / 0.075);
outline: lab(1.90334 0.278696 -5.48866) none 3px → rgb(0, 95, 204) auto 1px;
```

**"⌘KCtrl K"**
```css
/* Focus */
outline: rgb(0, 0, 0) none 3px → rgb(0, 95, 204) auto 1px;
```

**"Quick search⌘KCtrl K"**
```css
/* Focus */
outline: oklab(0.129999 -0.00404751 -0.027702 / 0.5) none 3px → rgb(0, 95, 204) auto 1px;
```

### Link Hover

```css
background-color: rgb(0, 0, 0) → lab(16.1051 -1.18239 -11.7533);
```
...
- 6754 duplicate CSS declarations
...
**31 unique SVG icons** detected. Dominant style: **outlined**.
...
- **custom** (260 uses) — `cubic-bezier(0.4, 0, 0.2, 1)`
...
**Detected:** `tailwindcss` (confidence 0.573)
...
|---------|---------|-----------|------|
| button--default--xs | 0 | 60 × 24 | `screenshots/button-default-xs-0.png` |
| button--default | 0 | 54 × 24 | `screenshots/button-default-0.png` |
| button--default--sm | 0 | 320 × 40 | `screenshots/button-default-sm-0.png` |
| button--default--sm | 1 | 75 × 28 | `screenshots/button-default-sm-1.png` |
| button--default--sm | 2 | 61 × 28 | `screenshots/button-default-sm-2.png` |
| button--default--lg | 0 | 147 × 40 | `screenshots/button-default-lg-0.png` |
| button--outline--sm | 0 | 400 × 136 | `screenshots/button-outline-sm-0.png` |
| button--outline--sm | 1 | 400 × 136 | `screenshots/button-outline-sm-1.png` |
| button--outline--sm | 2 | 400 × 136 | `screenshots/button-outline-sm-2.png` |
| input--default | 0 | 187 × 24 | `screenshots/input-default-0.png` |
