...
generated_at: "2026-07-02T08:29:49.148Z"
...
Component library appears to be **tailwindcss** (0.573).
...
**Layout primitives:** 75 grid containers · 162 flex containers.
...
**Detected patterns:** `buttons` · `cards` · `inputs` · `links` · `footer` · `dropdowns` · `tabs` · `tooltips`
...
- Don't 6754 duplicate css declarations.

---
_Generated by [designlang](https://github.com/Manavarya09/design-extract) v12.21.0 from <https://tailwindcss.com>._
